...
export const FILTER_BAR_CONTAINER =
  "text-sm sm:text-base flex flex-col gap-3 sm:gap-3 p-3 sm:p-4 bg-slate-800/50 rounded-xl border border-slate-700";

export const FILTER_BAR_TOP_ROW = "flex-row justify-between";
