...
export const DetailHeader: React.FC<DetailHeaderProps> = ({
  ...
  return (
    <>
      <div className="sticky top-0 z-20 flex flex-col w-full">
        <header
          id="detail-header"
          className="bg-slate-900/80 backdrop-blur-md border-b border-slate-800 p-2.5 sm:p-3.5 shadow-sm"
        >
        ...
        {/* Breadcrumbs - Below header, right aligned */}
